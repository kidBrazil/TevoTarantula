...
**- E0 pins are swapped with E1 pins in RAMPS.h**
**- Extruder Stepper should be connected to E1 physical port**
**- Hotend Thermistor pins are swapped in RAMPS.h**
**- Hotend Thermistor should connected to A15 physical port**
**- No Bed Auto Level**
