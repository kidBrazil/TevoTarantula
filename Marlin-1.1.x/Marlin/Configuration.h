...
#define STRING_CONFIG_H_AUTHOR "[LooseThermistor]" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "PRINT ALL THE THINGS!" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "Don't forget your towel!"         // will be shown during bootup in line 2
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 178.72
  #define  DEFAULT_bedKi  32.47
  #define  DEFAULT_bedKd 245.96
  //120V 250W silicone heater into 4mm borosilicate (MendelMax 1.5+)
  //from pidautotune
